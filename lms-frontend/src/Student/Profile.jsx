...
class Profile extends Component{
    ...
    openUploadModal(studentId, profileImage) {
    ...
    openUpdateModal() {
        ...
        const { studentName, email, nic, dob, phoneNumber, address } = this.state.profileData;
        this.setState({
    ...
    uploadImageToDatabase = () => {
        ...
        const { studentId, profileImage } = this.state.profileData;
        ...
        if (selectedProfileImage && selectedProfileImage !== profileImage) {
            ...
            axios.put('http://localhost:8083/api/v1/student/upload/'+studentId, formData)
                .then(response => {
    ...
    handleUpdateProfile = () => {
        ...
        const { studentId } = this.state.profileData;


    axios.put('http://localhost:8083/api/v1/student/update/'+ studentId, updatedProfileData)
        .then(response => {
                        ...
                        <div className="col-md-5">
                            ...
                            <div style={{display:"inline-flex"}}>
                                <div style={{marginLeft:"80px"}}>
                                    {/* <button className="btn btn-primary" onClick={this.openUploadModal(studentId, profileImageSrc)}>Upload Profile Image</button> */}
                                    <button className="btn btn-primary" onClick={() => this.openUploadModal(studentId, profileImage)}>Upload Profile Image</button>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" 
                                                                    ...
                                                                    name="studentName"
                                                                    value={this.state.updatedProfile.studentName}
                                                                />
                                                            </td>
                                                        </tr>
                                                        <tr>
