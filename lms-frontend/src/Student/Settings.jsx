    ...
    handleSubmit = (event) => {
        ...
        if (Object.keys(errors).length === 0) {
          ...
          //  console.log("Form submitted!");
            ...
            axios.put(`http://localhost:8083/api/v1/student/updatepassword`, formData)
            .then(response => {
                    ...
                    <div className="col-md-6">
                        <form>
                            <div style={{marginTop:'30px',marginLeft:'250px', width:'55%'}}>
                                ...
                                <div style={{marginTop:'15px'}}>
                                    <input type="submit" value="Update Password" style={{marginLeft:'100px'}} onClick={this.handleSubmit} className="btn btn-outline-primary"/>
                                </div>
