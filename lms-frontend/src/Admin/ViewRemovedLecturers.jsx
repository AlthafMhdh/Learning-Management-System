...
class ViewRemovedLecturers extends Component{
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:8083/api/v1/lecturer/allremovedlecturers') 
            .then(response => {
    ...
    activeLecturer = (lecturerId) => {
        
        axios.put("http://localhost:8083/api/v1/lecturer/active/" + lecturerId)
            .then(response => {
                alert(response.data.data);
                console.log('Lecturer activeted successfully');
                this.componentDidMount();
            })
            .catch(error => {
                // Handle error if needed
                console.error('Error active lecturer:', error);
            });
    };
                                    ...
                                    <td>
                                        <div style={{display:"inline-flex"}}>
                                            ...
                                            <div style={{paddingLeft:"10px"}}>
                                                <button className="btn btn-primary" onClick={() => this.activeLecturer(lecturer.lecturerId)} >Active</button>
                                            </div>
                                        </div>                                        
                                    </td>
                                </tr>
...
export default ViewRemovedLecturers;